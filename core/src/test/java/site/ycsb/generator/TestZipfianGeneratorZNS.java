...
//    final int num_zones = 100;
    ...
    final Workload[] workloads = {
        ...
        new Workload((int) Math.pow(2, 16), 40632, 49152000, 1, 2, Optional.empty(), Optional.empty(), "promotional", 904),
        new Workload((int) Math.pow(2, 28), 3209583, 12_000, 4, 16, Optional.empty(), Optional.empty(), "promotional", 904),
        new Workload((int) Math.pow(2, 29), 5413781, 6_000, 8, 16, Optional.empty(), Optional.empty(), "promotional", 904),
        new Workload(zone_size, 11524248, 3_000, 8, 24, Optional.empty(), Optional.empty(), "promotional", 904),
    };
